...
import com.kygoinc.edusphere.databinding.ActivityTaskBinding
...
class TaskActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val labels = arrayListOf("Personal", "Learn", "Assignment", "Project", "Review")
    ...
    private fun setTimeListener() {
        ...
        val timePickerDialog = TimePickerDialog(
            this, R.style.MyTimePickerDialogStyle ,timeSetListener, myCalendar.get(Calendar.HOUR_OF_DAY),
    ...
    private fun setListener() {
        ...
        val datePickerDialog = DatePickerDialog(
            this, R.style.MyDatePickerDialogStyle, dateSetListener, myCalendar.get(Calendar.YEAR),
